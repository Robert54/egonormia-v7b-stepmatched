#!/bin/bash
# Portable launcher for the v6 natural-language-output SFT run.
...
TEMPLATE="${ROOT_DIR}/configs/egonormia_sft_v6.toml.template"
...
RUN_NAME="egonormia_sft_v6_seed${SEED}"
EXPERIMENT_NAME="egonormia_sft_v6_nloutput_seed${SEED}"
